...
def _row_strategy(stage_strategy, changes_strategy):
    return st.fixed_dictionaries({
        ...
        "account": st.text(alphabet=_TEXT_ALPHABET, max_size=30),
        "opp_name": st.text(alphabet=_TEXT_ALPHABET, max_size=40),
        "owner": st.text(alphabet=_TEXT_ALPHABET, max_size=30),
        ...
        "next_step": st.text(alphabet=_TEXT_ALPHABET, max_size=60),
        "next_step_date": _opt_dates,
        "forecast_category": _forecasts,
        "contact_count": st.integers(min_value=0, max_value=50),
        "product_line": st.text(alphabet=_TEXT_ALPHABET, max_size=20),
